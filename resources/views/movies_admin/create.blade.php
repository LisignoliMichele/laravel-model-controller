...
<div class="container">
   <form action="{{route('movies.store')}}" method="POST" class="form-horizontal">
      ...
      <div class="form-group">
         ...
         <div class="col-sm-10">
           <input name="movie_director" type="text" class="form-control" id="Regista" placeholder="Regista">
         </div>
       </div>
       <div class="form-group">
         <label for="Genere" class="col-sm-2 control-label">GENERE</label>
         <div class="col-sm-10">
           <input name="genres" type="text" class="form-control" id="Genere" placeholder="Genere">
         </div>
       </div>
       <div class="form-group">
         <label for="Trama" class="col-sm-2 control-label">TRAMA</label>
         <div class="col-sm-10">
            <textarea name="plot" id="Trama" cols="30" rows="10" class="form-control" placeholder="Trama"></textarea>
         </div>
       </div>
       <div class="form-group">
